...
import type { MutationSelector, QuerySelector, UseLazyQuery, UseMutation, UseQuery } from './hooks-types';
  ...
  ? Keys extends string
    ? Definitions[Keys] extends { type: DefinitionType.query }
      ? {
          ...
          [K in Keys as `select${Capitalize<K>}Query`]: QuerySelector<
            Extract<Definitions[K], QueryDefinition<any, any, any, any>>
          >;
        }
      ...
      ? {
          ...
          [K in Keys as `select${Capitalize<K>}Mutation`]: MutationSelector<
            Extract<Definitions[K], MutationDefinition<any, any, any, any>>
          >;
        }
      : never
